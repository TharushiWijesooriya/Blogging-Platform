...
const page = () => {
    ...
    const onSubmitHandler = async (e) =>{
        ...
        //calling API to link to mongoDB
  ...
  return (
    <>
        <form onSubmit={onSubmitHandler} className='pt-5 px-5 sm:pt-12 sm:pl-16'>
            ...
            <br/>
            <button type='submit' className='transform transition-transform hover:scale-105 mt-8 w-40 h-12 bg-black text-white'>
                ADD
            </button>
        </form>
